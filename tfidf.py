...
class Tfidf:
    ...
    def compare_texts(self, text1, text2):
        ...
        messages = [
            {"role": "system",
             "content": "You are a professional journalist evaluating the similarity of two articles. Two articles are considered similar if they discuss the same topic, cite the same sources or protagonists, and present the same informations."},
        ...
        out = openai.completions(messages=messages)
        return out in ('True', 'true', '1')
